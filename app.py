...
def home():
    ...
    try:
        ...
        if category == "all":
            endpoints = [("movies", "movies", "movies"), ("tvshows", "series", "tvshows"), ("ani", "anime", "ani")]
            ...
            for i in range(2):
                ...
                raw_results = data.get("tvshows") or data.get("series") or data.get("results") or data.get("data") or []
